...
--
-- Host: localhost
-- Generation Time: Feb 25, 2024 at 09:00 PM
...
INSERT INTO `predictions` (`id`, `symptoms`, `predictedDisease`, `patient_id`) VALUES
(72, 'painful_urination,abnormal_discharge,pain_during_sex', 'Chlamydia', 'John'),
(73, 'painful_urination,abnormal_discharge,pain_during_sex', 'Chlamydia', 'John');
...
INSERT INTO `prescription` (`id`, `symptoms_id`, `prescription`) VALUES
(2, 20, 'Panadol 20X3'),
(3, 20, 'Panadol 20X3'),
(4, 20, 'Panadol 20X3'),
(5, 72, 'Panadol 20X3');
